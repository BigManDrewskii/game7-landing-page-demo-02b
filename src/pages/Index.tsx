  ...
  return (
    <main className="max-w-none flex flex-col justify-center items-center w-full min-h-screen bg-[#0D0D0D] box-border mx-auto px-6 py-12 sm:px-8 sm:py-16 md:px-10 md:py-20">
      <section className="flex flex-col items-center gap-8 sm:gap-10 max-w-3xl w-full">
        ...
        <h1 className="font-unbounded text-5xl sm:text-6xl md:text-7xl lg:text-[80px] font-medium leading-tight sm:leading-tight md:leading-tight lg:leading-[1.15] text-center text-white tracking-[-0.02em]">
          Be the first to know.
        </h1>

        <p className="text-base sm:text-lg md:text-xl font-normal leading-relaxed text-center text-zinc-400 max-w-xl px-4">
